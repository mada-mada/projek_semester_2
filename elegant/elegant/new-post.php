...
<div class="page-flex"
  ...
  <div class="container main-nav">
    ...
    <div class="main-nav-end">
      ...
      <div class="nav-user-wrapper">
        ...
        <ul class="users-item-dropdown nav-user-dropdown dropdown">
          ...
          <li><form method="POST" action="proses.php" >
    ...
    <main class="main users chart-page" id="skip-target">
      <div class="container">
      <form method="POST" action="proses-crud.php" enctype="multipart/form-data">
      <h4>title : 
        <br> <br>
...
<div class="d-grid gap-2 d-md-flex justify-content-md-end">
    <button class="btn btn-primary px-4" type="submit" name="create">Tambah artikel</button>
</div>
    </form>
  </div>
    </main>
