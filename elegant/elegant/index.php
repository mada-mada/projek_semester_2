...
$row = mysqli_fetch_assoc($admin); // ambil data dari hasil query
$admin_id = $row['admin_id'];
$queryorganisasi="SELECT * FROM organizations where admin_id='$admin_id'";
$organisasi=mysqli_query($connection, $queryorganisasi);
$row1= mysqli_fetch_assoc($organisasi);
$organisasi_id= $row1['organization_id'];

$query= "SELECT * FROM articles WHERE admin_id = '$organisasi_id';";
        ...
        <div class="sidebar-body">
            <ul class="sidebar-body-menu">
                ...
                <li>
                    ...
                    <ul class="cat-sub-menu">
                        <li>
                            <a href="cate.html">All categories</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <td>
                      <label class="users-table__checkbox">
                        ...
                        <div class="categories-table-img">
                          <img src="../../folder-foto/<?php echo $result ['image'] ?>" alt="thumbnail">
                        </div>
                      </label>
                    </td>
                    <td>
                    ...
                    <td>
                      <span class="p-relative">
                        ...
                        <ul class="users-item-dropdown dropdown">
                          <li><a href="update.php?ubah=<?php echo $result['article_id']?>">Edit</a></li>
                          <li>
                             <a href="proses-delete.php?hapus=<?php echo $result['article_id']; ?>"
          ...
          <div class="col-lg-3">
            ...
            <article class="white-block">
              <div class="top-cat-title">
                ...
                <p>4 categories, 40 Posts</p>
              </div>
              <ul class="top-cat-list">
                <li>
                  <a href="##">
                    <div class="top-cat-list__title">
                      Kampus <span>8.2k</span>
                    </div>
